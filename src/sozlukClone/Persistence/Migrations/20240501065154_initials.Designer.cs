...
namespace Persistence.Migrations
{
    ...
    [Migration("20240501065154_initials")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6bf6c8d1-b2e9-46f9-85b0-f05e89875adf"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sozluk@email.com",
                            PasswordHash = new byte[] { 139, 34, 253, 127, 47, 57, 190, 21, 67, 122, 157, 11, 8, 251, 22, 203, 75, 59, 170, 123, 177, 16, 89, 74, 11, 93, 181, 167, 41, 55, 231, 233, 26, 23, 214, 99, 38, 235, 245, 198, 175, 87, 73, 212, 97, 183, 15, 156, 196, 24, 18, 154, 3, 212, 90, 31, 95, 203, 126, 24, 6, 222, 173, 49 },
                            PasswordSalt = new byte[] { 168, 132, 124, 15, 75, 12, 213, 6, 74, 122, 38, 4, 123, 160, 251, 174, 229, 28, 201, 213, 166, 209, 62, 128, 44, 168, 24, 169, 175, 141, 207, 15, 102, 49, 155, 93, 244, 41, 21, 157, 249, 57, 111, 173, 184, 189, 236, 0, 246, 149, 203, 211, 145, 38, 157, 170, 75, 233, 80, 231, 56, 28, 10, 118, 209, 175, 94, 107, 252, 249, 183, 153, 0, 135, 246, 109, 124, 18, 136, 40, 251, 218, 85, 162, 142, 8, 237, 70, 89, 81, 80, 91, 12, 138, 44, 147, 41, 19, 64, 71, 195, 128, 161, 200, 196, 96, 207, 155, 65, 131, 51, 102, 136, 174, 51, 119, 15, 169, 27, 203, 173, 253, 173, 183, 170, 77, 75, 235 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("178e284f-369b-4b30-baab-d0193a146c83"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("6bf6c8d1-b2e9-46f9-85b0-f05e89875adf")
                        });
                });
