...
namespace Persistence.Migrations
{
    ...
    [Migration("20240430143014_FixDataSeed")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6cb77ce1-90bc-41b9-8f9d-fc8b19a14aea"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sozluk@email.com",
                            PasswordHash = new byte[] { 199, 81, 152, 254, 193, 176, 7, 205, 9, 143, 108, 180, 10, 253, 19, 74, 233, 124, 179, 65, 255, 218, 87, 101, 4, 23, 72, 189, 170, 128, 240, 224, 221, 59, 34, 204, 202, 64, 87, 161, 145, 187, 71, 179, 89, 39, 72, 137, 138, 193, 136, 36, 31, 99, 206, 143, 4, 59, 35, 244, 107, 130, 199, 200 },
                            PasswordSalt = new byte[] { 244, 129, 255, 131, 42, 192, 17, 69, 89, 250, 189, 3, 81, 215, 99, 102, 242, 52, 183, 46, 125, 204, 12, 10, 137, 74, 148, 216, 32, 82, 41, 148, 22, 206, 137, 156, 156, 38, 62, 105, 117, 96, 8, 159, 122, 80, 93, 153, 62, 4, 43, 7, 176, 176, 25, 27, 120, 177, 10, 22, 63, 151, 175, 95, 216, 51, 117, 211, 142, 137, 77, 81, 69, 67, 217, 113, 170, 215, 199, 213, 65, 9, 85, 13, 149, 170, 61, 133, 146, 133, 221, 146, 70, 162, 170, 184, 14, 238, 13, 216, 170, 216, 248, 107, 200, 230, 119, 211, 143, 82, 192, 42, 225, 99, 27, 62, 242, 91, 31, 76, 34, 124, 145, 6, 70, 244, 225, 179 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f209f83-9959-43f0-bd1a-31d01a14cfad"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("6cb77ce1-90bc-41b9-8f9d-fc8b19a14aea")
                        });
                });
