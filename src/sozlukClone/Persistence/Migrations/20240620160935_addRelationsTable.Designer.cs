...
namespace Persistence.Migrations
{
    ...
    [Migration("20240620160935_addRelationsTable")]
    partial class addRelationsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActiveBadgeId = 1,
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 20, 16, 9, 35, 85, DateTimeKind.Utc).AddTicks(2685),
            ...
            modelBuilder.Entity("Domain.Entities.AuthorGroupUserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c5bf34b6-4fcb-4620-ae3d-4c614c01d398"),
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 20, 16, 9, 35, 86, DateTimeKind.Utc).AddTicks(4547),
                            OperationClaimId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 20, 16, 9, 35, 89, DateTimeKind.Utc).AddTicks(7405),
                            TitleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.GlobalSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 20, 16, 9, 35, 90, DateTimeKind.Utc).AddTicks(5607),
            ...
            modelBuilder.Entity("Domain.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2024, 6, 20, 16, 9, 35, 94, DateTimeKind.Utc).AddTicks(8019),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 160, 30, 182, 38, 118, 8, 177, 237, 199, 125, 78, 157, 137, 127, 134, 42, 51, 48, 16, 174, 32, 110, 139, 16, 37, 200, 185, 48, 48, 60, 116, 94, 157, 164, 246, 54, 17, 118, 132, 192, 98, 21, 231, 78, 59, 143, 212, 70, 10, 176, 77, 202, 14, 143, 173, 112, 21, 154, 171, 209, 125, 153, 79, 116 },
                            PasswordSalt = new byte[] { 220, 233, 207, 40, 23, 6, 250, 182, 255, 89, 126, 27, 32, 49, 194, 90, 177, 73, 162, 56, 221, 179, 133, 196, 145, 83, 225, 151, 183, 164, 186, 207, 9, 84, 220, 112, 85, 172, 196, 117, 240, 208, 103, 83, 203, 4, 239, 52, 109, 4, 8, 127, 135, 128, 27, 192, 237, 95, 54, 81, 56, 137, 63, 101, 92, 122, 61, 199, 227, 133, 175, 72, 26, 87, 144, 18, 115, 150, 27, 63, 190, 156, 169, 199, 6, 25, 96, 145, 204, 224, 83, 250, 148, 80, 128, 7, 39, 155, 121, 78, 35, 31, 122, 253, 244, 247, 51, 39, 184, 77, 38, 105, 245, 232, 103, 63, 44, 123, 56, 182, 231, 167, 119, 84, 81, 30, 109, 211 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4112c50b-4038-4ddd-9703-01eebe4a8b80"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("029bf0d3-9429-44d7-9c30-51655e583ab6")
                        });
