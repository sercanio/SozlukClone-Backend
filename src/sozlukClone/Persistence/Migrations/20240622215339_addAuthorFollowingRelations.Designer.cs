...
namespace Persistence.Migrations
{
    ...
    [Migration("20240622215339_addAuthorFollowingRelations")]
    partial class addAuthorFollowingRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActiveBadgeId = 1,
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 22, 21, 53, 38, 316, DateTimeKind.Utc).AddTicks(7525),
            ...
            modelBuilder.Entity("Domain.Entities.AuthorGroupUserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dc0f7de6-fbd8-4c55-8180-d2404e1c4baa"),
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 22, 21, 53, 38, 317, DateTimeKind.Utc).AddTicks(9008),
                            OperationClaimId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 22, 21, 53, 38, 321, DateTimeKind.Utc).AddTicks(8504),
                            IsVisible = false,
                            TitleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.GlobalSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 22, 21, 53, 38, 322, DateTimeKind.Utc).AddTicks(6482),
            ...
            modelBuilder.Entity("Domain.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2024, 6, 22, 21, 53, 38, 325, DateTimeKind.Utc).AddTicks(9747),
                            IsLocked = false,
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 12, 173, 119, 180, 87, 187, 191, 13, 119, 17, 217, 150, 123, 78, 108, 105, 100, 63, 81, 119, 209, 99, 139, 208, 174, 18, 3, 93, 157, 111, 154, 98, 5, 245, 46, 24, 119, 228, 63, 127, 57, 15, 69, 77, 230, 3, 211, 144, 98, 133, 197, 76, 236, 167, 241, 35, 79, 122, 111, 220, 6, 171, 77, 121 },
                            PasswordSalt = new byte[] { 64, 53, 131, 126, 45, 50, 130, 167, 156, 79, 250, 214, 17, 79, 51, 91, 15, 39, 248, 155, 218, 159, 243, 216, 177, 96, 162, 67, 130, 239, 108, 146, 150, 111, 128, 196, 111, 196, 140, 35, 254, 53, 125, 48, 49, 17, 92, 2, 16, 104, 24, 139, 120, 39, 131, 191, 200, 19, 117, 223, 253, 202, 206, 153, 116, 72, 230, 160, 100, 0, 217, 53, 117, 15, 216, 201, 242, 201, 19, 233, 134, 13, 3, 68, 123, 61, 164, 187, 241, 127, 127, 150, 142, 166, 208, 114, 233, 202, 18, 10, 203, 59, 32, 2, 118, 124, 72, 205, 210, 159, 53, 109, 46, 21, 158, 219, 77, 211, 112, 167, 171, 51, 104, 93, 195, 140, 55, 131 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1245d97b-4290-43d5-b770-2dcc32684ec7"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("029bf0d3-9429-44d7-9c30-51655e583ab6")
                        });
