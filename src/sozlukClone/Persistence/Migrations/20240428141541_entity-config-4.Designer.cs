...
namespace Persistence.Migrations
{
    ...
    [Migration("20240428141541_entity-config-4")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("25670ac5-af69-45e7-a343-6890dfe353ee"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 163, 198, 22, 71, 82, 151, 87, 72, 86, 138, 26, 235, 5, 246, 30, 58, 24, 142, 51, 252, 2, 98, 151, 110, 81, 139, 8, 203, 117, 255, 38, 254, 158, 144, 231, 170, 22, 77, 228, 155, 233, 217, 165, 179, 196, 182, 43, 176, 149, 80, 114, 167, 48, 4, 0, 56, 43, 150, 133, 78, 133, 204, 174, 155 },
                            PasswordSalt = new byte[] { 203, 57, 214, 234, 135, 170, 242, 62, 231, 235, 211, 178, 121, 254, 123, 157, 220, 178, 134, 117, 165, 171, 140, 44, 74, 171, 38, 82, 192, 37, 64, 181, 210, 3, 229, 237, 152, 17, 116, 34, 212, 103, 148, 60, 151, 29, 241, 157, 115, 244, 126, 141, 139, 195, 47, 233, 116, 14, 107, 87, 17, 187, 253, 25, 81, 137, 97, 194, 197, 64, 104, 121, 115, 133, 238, 251, 228, 165, 121, 143, 49, 162, 15, 233, 11, 55, 147, 96, 174, 236, 11, 63, 13, 119, 189, 216, 118, 84, 49, 95, 155, 219, 197, 177, 185, 182, 178, 197, 27, 84, 63, 2, 125, 37, 79, 37, 51, 52, 0, 180, 83, 97, 18, 21, 142, 233, 169, 221 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8275b863-611c-4246-86c8-cf37593e834d"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("25670ac5-af69-45e7-a343-6890dfe353ee")
                        });
                });
