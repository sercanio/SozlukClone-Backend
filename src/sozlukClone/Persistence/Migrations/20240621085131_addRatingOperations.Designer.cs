...
namespace Persistence.Migrations
{
    ...
    [Migration("20240621085131_addRatingOperations")]
    partial class addRatingOperations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActiveBadgeId = 1,
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 21, 8, 51, 30, 797, DateTimeKind.Utc).AddTicks(4175),
            ...
            modelBuilder.Entity("Domain.Entities.AuthorGroupUserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bbed1591-80dd-4285-83c0-74af61de517c"),
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 21, 8, 51, 30, 798, DateTimeKind.Utc).AddTicks(8308),
                            OperationClaimId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 21, 8, 51, 30, 801, DateTimeKind.Utc).AddTicks(5671),
                            TitleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.GlobalSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 21, 8, 51, 30, 802, DateTimeKind.Utc).AddTicks(1215),
            ...
            modelBuilder.Entity("Domain.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2024, 6, 21, 8, 51, 30, 806, DateTimeKind.Utc).AddTicks(734),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 95, 79, 84, 204, 162, 101, 34, 34, 141, 29, 134, 132, 6, 35, 76, 5, 155, 130, 121, 166, 67, 174, 16, 198, 109, 103, 199, 149, 6, 161, 69, 94, 155, 221, 160, 16, 7, 211, 125, 180, 57, 172, 5, 48, 110, 104, 13, 254, 73, 189, 31, 141, 100, 27, 57, 129, 246, 82, 57, 55, 19, 233, 147, 250 },
                            PasswordSalt = new byte[] { 221, 57, 168, 212, 162, 165, 205, 51, 154, 223, 164, 116, 167, 43, 4, 8, 204, 95, 28, 185, 44, 50, 161, 72, 111, 177, 9, 16, 96, 152, 152, 230, 63, 250, 173, 154, 152, 118, 225, 17, 112, 18, 20, 184, 68, 29, 34, 29, 185, 142, 110, 37, 38, 165, 200, 197, 179, 226, 164, 79, 33, 46, 178, 24, 83, 217, 254, 149, 190, 138, 202, 140, 254, 112, 209, 41, 154, 9, 186, 33, 242, 147, 177, 139, 230, 206, 53, 141, 175, 84, 151, 52, 39, 34, 91, 1, 126, 10, 4, 208, 158, 214, 20, 7, 19, 103, 36, 143, 171, 80, 242, 58, 249, 216, 253, 102, 152, 157, 209, 80, 135, 159, 139, 89, 62, 208, 165, 157 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e04dfc0d-f127-4be2-beac-b41543ea4304"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("029bf0d3-9429-44d7-9c30-51655e583ab6")
                        });
