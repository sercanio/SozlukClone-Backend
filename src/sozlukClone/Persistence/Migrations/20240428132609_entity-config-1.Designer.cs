...
namespace Persistence.Migrations
{
    ...
    [Migration("20240428132609_entity-config-1")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c973d93c-927c-4b4e-8726-72db2e2aac81"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 101, 127, 176, 98, 188, 255, 15, 1, 32, 66, 200, 199, 182, 24, 180, 157, 7, 38, 92, 239, 58, 136, 135, 132, 117, 49, 122, 80, 4, 164, 73, 217, 186, 112, 130, 96, 186, 122, 250, 155, 158, 187, 223, 177, 44, 22, 189, 118, 104, 29, 25, 193, 21, 234, 107, 222, 95, 106, 101, 137, 160, 134, 200, 111 },
                            PasswordSalt = new byte[] { 229, 71, 27, 226, 105, 66, 183, 212, 28, 34, 155, 74, 53, 139, 178, 155, 135, 222, 9, 86, 36, 210, 235, 148, 150, 189, 242, 67, 55, 98, 87, 168, 175, 248, 76, 230, 169, 51, 220, 255, 13, 229, 217, 184, 70, 223, 189, 7, 150, 169, 196, 183, 65, 153, 228, 173, 196, 181, 29, 183, 126, 53, 91, 142, 143, 158, 134, 117, 139, 125, 99, 97, 159, 230, 200, 207, 207, 221, 54, 97, 231, 38, 59, 158, 112, 93, 106, 188, 95, 8, 64, 110, 168, 186, 245, 47, 72, 108, 206, 178, 39, 132, 246, 129, 38, 34, 188, 149, 31, 205, 14, 195, 20, 183, 165, 180, 217, 238, 69, 224, 23, 226, 241, 251, 243, 112, 34, 31 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e5c5a971-bae6-4d09-8d0d-488614bbfe86"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("c973d93c-927c-4b4e-8726-72db2e2aac81")
                        });
                });
