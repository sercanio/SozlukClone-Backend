...
namespace Persistence.Migrations
{
    ...
    [Migration("20240624120255_RemoveCompositeKeyFromAuthorFollowings")]
    partial class RemoveCompositeKeyFromAuthorFollowings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActiveBadgeId = 1,
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 24, 12, 2, 54, 216, DateTimeKind.Utc).AddTicks(4526),
            ...
            modelBuilder.Entity("Domain.Entities.AuthorGroupUserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a01da53d-64bf-44a9-92c8-10ec3b9d0819"),
                            AuthorGroupId = 1,
                            CreatedDate = new DateTime(2024, 6, 24, 12, 2, 54, 217, DateTimeKind.Utc).AddTicks(6678),
                            OperationClaimId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Entry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 24, 12, 2, 54, 223, DateTimeKind.Utc).AddTicks(428),
                            IsVisible = false,
                            TitleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.GlobalSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 24, 12, 2, 54, 223, DateTimeKind.Utc).AddTicks(8937),
            ...
            modelBuilder.Entity("Domain.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedDate = new DateTime(2024, 6, 24, 12, 2, 54, 226, DateTimeKind.Utc).AddTicks(6921),
                            IsLocked = false,
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("91133532-b8b6-4698-b831-a76d148ea354"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("029bf0d3-9429-44d7-9c30-51655e583ab6")
                        });
